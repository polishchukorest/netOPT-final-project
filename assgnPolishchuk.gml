...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
  <key attr.name="dist" attr.type="int" for="edge" id="d3" />
  <key attr.name="profit" attr.type="int" for="node" id="d2" />
  ...
  <graph edgedefault="directed">
    ...
    <node id="4">
      <data key="d0">26</data>
      <data key="d1">1</data>
      <data key="d2">1747</data>
    </node>
    <node id="5">
      <data key="d0">2</data>
      <data key="d1">22</data>
      <data key="d2">1483</data>
    </node>
    <node id="6">
      <data key="d0">9</data>
      <data key="d1">18</data>
    ...
    <node id="7">
      <data key="d0">46</data>
      <data key="d1">23</data>
      <data key="d2">1518</data>
    </node>
    <node id="8">
      <data key="d0">10</data>
      <data key="d1">8</data>
      <data key="d2">340</data>
    </node>
    <node id="9">
      <data key="d0">13</data>
      <data key="d1">3</data>
    ...
    <node id="12">
      <data key="d0">4</data>
      <data key="d1">20</data>
      <data key="d2">939</data>
    </node>
    <node id="13">
      <data key="d0">35</data>
      <data key="d1">23</data>
      <data key="d2">768</data>
    </node>
    <node id="14">
      <data key="d0">32</data>
      <data key="d1">8</data>
    ...
    <edge source="11" target="3">
      <data key="d3">3219</data>
    </edge>
    <edge source="11" target="4">
      <data key="d3">3082</data>
    </edge>
